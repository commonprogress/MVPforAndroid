...
public class GlideImageView extends ImageView {
    ...
    public GlideImageView diskCacheStrategy(DiskCacheStrategy strategy) {
    ...
    public void loadDrawable(@DrawableRes int resId, @DrawableRes int placeholder, Transformation<Bitmap> transformation) {
